...
def main_func():
    ...
    for PositionVector[44] in theta:    #44 for 6x6
        
        #print('*************\n**********\n************\n***************', PositionVector[5])
        
        PositionVector = pos_vec if PositionVector[44] == 0.0 else PositionVector
        ...
        print(PositionVector[44], EnergyInSprings[EnergyInSprings != 0][-1], j)
